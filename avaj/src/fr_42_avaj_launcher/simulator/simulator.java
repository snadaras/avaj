...
public class Simulator {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (file.isDirectory()) {
                System.out.println("File " + args[0] + " is a actually a directory, not a regular file.");
                System.exit(1);
            }
            ...
            if (line != null) {
                ...
                try {
                    ...
                    throw new ScenarioFileException("Invalid Scenario file: An integer is expected.");
                }
                if (simulations < 0) {
                    System.out.println("Invalid simulation counter " + simulations);
                    System.exit(1);
                }
                while ((line = reader.readLine()) != null) {
                    ...
                    if (tokens.length != 5) {
                        throw new ScenarioFileException("Invalid scenario file: Aircraft description not in the expected format: Type/Name/Longitude/Latitude/Height");
                    }
            ...
            System.out.println("Couldn't find the input file " + args[0]);
        } catch (IOException e) {
